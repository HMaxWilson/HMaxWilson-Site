  ...
  <div class="about p-4">
    <div class="container mx-auto text-xl space-y-4 max-w-4xl">
      <p>
        ...
        <strong>software engineering</strong> with web development to deliver <strong>high-performance, user-friendly solutions</strong>.
      </p>

      <p>
        My academic journey started with <strong>2 years of Computer Science GCSE</strong>, followed by <strong>2 years of IT in college</strong>,
        <strong>1 year of Computer Science at the University of Hertfordshire</strong>, and <strong>3 years studying Games Programming at
        Bournemouth University</strong>. This foundation provided me with strong <strong>problem-solving abilities</strong> and a keen
        understanding of both the <strong>front and back end</strong> of development.
      </p>
      ...
      <ul class="space-y-4 sm:p-4">
        <li class="flex flex-col sm:flex-row items-center space-x-4">
          ...
          <p>
            As a Software Engineer for <strong>Drilling Systems</strong>, I spent a year fixing critical bugs for a simulation
      ...
      <p>
        I’m passionate about leveraging my <strong>diverse skill set</strong> to solve complex problems and build innovative,
        <strong>scalable digital solutions</strong>.
      </p>
    </div>
  </div>
</template>