<template>
  <footer class="bg-gray-300 dark:bg-black border-t border-gray-400 dark:border-gray-500 text-gray-800 dark:text-gray-200">
    <div class="container mx-auto py-4 px-4">
      <div class="flex flex-wrap items-center justify-between">
        ...
        <div class="hidden sm:block text-sm">
          Phone: <a href="tel:07562763552">07562 763 552</a> <br/>
          Email: <a href="mailto:H.MaxWilson@hotmail.com">H.MaxWilson@hotmail.com</a>
        </div>
      </div>
